...
class ChessPiecesControllerTest < ActionController::TestCase
  ...
  test "should create chess_piece" do
    assert_difference('ChessPiece.count') do
      post :create, chess_piece: { initialCol: @chess_piece.initialCol, initialRow: @chess_piece.initialRow, integer: @chess_piece.integer, pieceImage: @chess_piece.pieceImage, pieceType: @chess_piece.pieceType }
    end
  ...
  test "should update chess_piece" do
    patch :update, id: @chess_piece, chess_piece: { initialCol: @chess_piece.initialCol, initialRow: @chess_piece.initialRow, integer: @chess_piece.integer, pieceImage: @chess_piece.pieceImage, pieceType: @chess_piece.pieceType }
    assert_redirected_to chess_piece_path(assigns(:chess_piece))
  end
