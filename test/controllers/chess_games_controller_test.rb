...
class ChessGamesControllerTest < ActionController::TestCase
  ...
  test "should create chess_game" do
    assert_difference('ChessGame.count') do
      post :create, chess_game: { accessCode: @chess_game.accessCode, gameType: @chess_game.gameType, publicMatch: @chess_game.publicMatch }
    end
  ...
  test "should update chess_game" do
    patch :update, id: @chess_game, chess_game: { accessCode: @chess_game.accessCode, gameType: @chess_game.gameType, publicMatch: @chess_game.publicMatch }
    assert_redirected_to chess_game_path(assigns(:chess_game))
  end
